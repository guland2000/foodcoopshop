...
foodcoopshop.AppCkeditor = {
    ...
    init: function (name, startupFocus) {
        ...
        */
        ...
        this.createClassicEditor(name, toolbar);
    ...
    createClassicEditor: function(name, toolbar) {

        const uploadTargetHash = 'l1_Lw';
        const connectorUrl = '/js/elfinder/php/connector.minimal.php';
